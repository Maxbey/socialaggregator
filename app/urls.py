...
urlpatterns = [
    ...
    url(r'^auth/email-confirmation/(?P<key>\w{64})/$', ConfirmEmailView.as_view(), name='confirm_email'),
    url(r'^auth/email-confirmation/(?P<key>\w+)/$', confirm_email, name="account_confirm_email"),
